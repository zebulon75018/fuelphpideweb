 <?php 
function recursive_menumetis( $obj ,$deep)
           {
             if ( is_array($obj) ) {
...
<li class="">
            <a href="javascript:;">
              ...
              <span class="link-title"><?php echo $obj["name"]?></span> 
...
<?php
                        ...
                        { ?>
			<li>
                            <a href="javascript:;"><?php echo $obj["name"]; ?><span class="fa arrow"></span>  </a> 
                        <ul>
                        <?php }
...
?>
				<li class="">
            				<a href="dashboard.html">
              					<i class="fa fa-dashboard"></i><span class="link-title">&nbsp;<?php echo $obj["name"]; ?></span> 
            				</a> 
          			</li>
<?php
                        }
...
<?php
  $menuarray = array(
                        ...
                        array ( "name"=>"test3" ),
                        array ( "name"=>"test",
				"children"=> array(array("name"=>"test2","children"=>array(array("name"=>"test3")) )))
                        );
        foreach( $menuarray as $m )
        {
           recursive_menumetis($m,0);
        }
